...
// APIClient manages communication with the Deploy API v1 API vv1
...
type APIClient struct {
	...
	CodeScanResultsAPI *CodeScanResultsAPIService
	...
	DiskAttachmentsAPI *DiskAttachmentsAPIService
	...
	PersistentDisksAPI *PersistentDisksAPIService
	...
	VhostsAPI *VhostsAPIService

	VpcPeersAPI *VpcPeersAPIService

	VpnTunnelsAPI *VpnTunnelsAPIService
}
...
func NewAPIClient(cfg *APIConfiguration) *APIClient {
	...
	c.DiskAttachmentsAPI = (*DiskAttachmentsAPIService)(&c.common)
	...
	c.VhostsAPI = (*VhostsAPIService)(&c.common)
	c.VpcPeersAPI = (*VpcPeersAPIService)(&c.common)
	c.VpnTunnelsAPI = (*VpnTunnelsAPIService)(&c.common)
...
func formatErrorMessage(status string, v interface{}) string {
	...
	if metaValue.Kind() == reflect.Struct {
		...
		// field = metaValue.FieldByName("Code")
		// if field != (reflect.Value{}) {
		// 	str = fmt.Sprintf("%s (%v)", str, field.Interface())
		// }
	}

	return strings.TrimSpace(fmt.Sprintf("%s (%s)", str, status))
}
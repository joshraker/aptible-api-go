...
// checks if the ListDiskAttachmentsForService200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDiskAttachmentsForService200Response{}

// ListDiskAttachmentsForService200Response struct for ListDiskAttachmentsForService200Response
type ListDiskAttachmentsForService200Response struct {
...
type _ListDiskAttachmentsForService200Response ListDiskAttachmentsForService200Response
...
func NewListDiskAttachmentsForService200Response(embedded ListDiskAttachmentsForAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListDiskAttachmentsForService200ResponseLinks) *ListDiskAttachmentsForService200Response {
	this := ListDiskAttachmentsForService200Response{}
...
func (o ListDiskAttachmentsForService200Response) MarshalJSON() ([]byte, error) {
...
func (o ListDiskAttachmentsForService200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListDiskAttachmentsForService200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDiskAttachmentsForService200Response := _ListDiskAttachmentsForService200Response{}

	err = json.Unmarshal(data, &varListDiskAttachmentsForService200Response)

	if err != nil {
		return err
	}

	*o = ListDiskAttachmentsForService200Response(varListDiskAttachmentsForService200Response)
...
type NullableListDiskAttachmentsForService200Response struct {
	value *ListDiskAttachmentsForService200Response
	isSet bool
}

func (v NullableListDiskAttachmentsForService200Response) Get() *ListDiskAttachmentsForService200Response {
	return v.value
}

func (v *NullableListDiskAttachmentsForService200Response) Set(val *ListDiskAttachmentsForService200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDiskAttachmentsForService200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDiskAttachmentsForService200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDiskAttachmentsForService200Response(val *ListDiskAttachmentsForService200Response) *NullableListDiskAttachmentsForService200Response {
	return &NullableListDiskAttachmentsForService200Response{value: val, isSet: true}
}

func (v NullableListDiskAttachmentsForService200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDiskAttachmentsForService200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

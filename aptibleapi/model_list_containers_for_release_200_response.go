...
// checks if the ListContainersForRelease200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListContainersForRelease200Response{}

// ListContainersForRelease200Response struct for ListContainersForRelease200Response
type ListContainersForRelease200Response struct {
	Embedded ListContainersForRelease200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListContainersForRelease200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListContainersForRelease200Response ListContainersForRelease200Response
...
func NewListContainersForRelease200Response(embedded ListContainersForRelease200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListContainersForRelease200ResponseLinks) *ListContainersForRelease200Response {
	this := ListContainersForRelease200Response{}
...
func (o *ListContainersForRelease200Response) GetEmbedded() ListContainersForRelease200ResponseEmbedded {
	if o == nil {
		var ret ListContainersForRelease200ResponseEmbedded
		return ret
	}
...
func (o *ListContainersForRelease200Response) GetLinks() ListContainersForRelease200ResponseLinks {
	if o == nil {
		var ret ListContainersForRelease200ResponseLinks
		return ret
	}
...
func (o ListContainersForRelease200Response) MarshalJSON() ([]byte, error) {
...
func (o ListContainersForRelease200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListContainersForRelease200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListContainersForRelease200Response := _ListContainersForRelease200Response{}

	err = json.Unmarshal(data, &varListContainersForRelease200Response)

	if err != nil {
		return err
	}

	*o = ListContainersForRelease200Response(varListContainersForRelease200Response)
...
type NullableListContainersForRelease200Response struct {
	value *ListContainersForRelease200Response
	isSet bool
}

func (v NullableListContainersForRelease200Response) Get() *ListContainersForRelease200Response {
	return v.value
}

func (v *NullableListContainersForRelease200Response) Set(val *ListContainersForRelease200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListContainersForRelease200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListContainersForRelease200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListContainersForRelease200Response(val *ListContainersForRelease200Response) *NullableListContainersForRelease200Response {
	return &NullableListContainersForRelease200Response{value: val, isSet: true}
}

func (v NullableListContainersForRelease200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListContainersForRelease200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

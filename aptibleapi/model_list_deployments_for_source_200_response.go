...
// checks if the ListDeploymentsForSource200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDeploymentsForSource200Response{}
...
type _ListDeploymentsForSource200Response ListDeploymentsForSource200Response
...
func (o ListDeploymentsForSource200Response) MarshalJSON() ([]byte, error) {
...
func (o ListDeploymentsForSource200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListDeploymentsForSource200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDeploymentsForSource200Response := _ListDeploymentsForSource200Response{}

	err = json.Unmarshal(data, &varListDeploymentsForSource200Response)

	if err != nil {
		return err
	}

	*o = ListDeploymentsForSource200Response(varListDeploymentsForSource200Response)
...
type NullableListDeploymentsForSource200Response struct {
	value *ListDeploymentsForSource200Response
	isSet bool
}

func (v NullableListDeploymentsForSource200Response) Get() *ListDeploymentsForSource200Response {
	return v.value
}

func (v *NullableListDeploymentsForSource200Response) Set(val *ListDeploymentsForSource200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDeploymentsForSource200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDeploymentsForSource200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDeploymentsForSource200Response(val *ListDeploymentsForSource200Response) *NullableListDeploymentsForSource200Response {
	return &NullableListDeploymentsForSource200Response{value: val, isSet: true}
}

func (v NullableListDeploymentsForSource200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDeploymentsForSource200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

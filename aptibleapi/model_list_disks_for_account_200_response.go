...
// checks if the ListDisksForAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDisksForAccount200Response{}

// ListDisksForAccount200Response struct for ListDisksForAccount200Response
type ListDisksForAccount200Response struct {
	Embedded ListDisksForAccount200ResponseEmbedded `json:"_embedded"`
...
type _ListDisksForAccount200Response ListDisksForAccount200Response
...
func NewListDisksForAccount200Response(embedded ListDisksForAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListActivityReportsForAccount200ResponseLinks) *ListDisksForAccount200Response {
	this := ListDisksForAccount200Response{}
...
func (o *ListDisksForAccount200Response) GetEmbedded() ListDisksForAccount200ResponseEmbedded {
	if o == nil {
		var ret ListDisksForAccount200ResponseEmbedded
		return ret
	}
...
func (o ListDisksForAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o ListDisksForAccount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListDisksForAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDisksForAccount200Response := _ListDisksForAccount200Response{}

	err = json.Unmarshal(data, &varListDisksForAccount200Response)

	if err != nil {
		return err
	}

	*o = ListDisksForAccount200Response(varListDisksForAccount200Response)
...
type NullableListDisksForAccount200Response struct {
	value *ListDisksForAccount200Response
	isSet bool
}

func (v NullableListDisksForAccount200Response) Get() *ListDisksForAccount200Response {
	return v.value
}

func (v *NullableListDisksForAccount200Response) Set(val *ListDisksForAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDisksForAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDisksForAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDisksForAccount200Response(val *ListDisksForAccount200Response) *NullableListDisksForAccount200Response {
	return &NullableListDisksForAccount200Response{value: val, isSet: true}
}

func (v NullableListDisksForAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDisksForAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

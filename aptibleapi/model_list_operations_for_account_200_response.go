...
// checks if the ListOperationsForAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForAccount200Response{}

// ListOperationsForAccount200Response struct for ListOperationsForAccount200Response
type ListOperationsForAccount200Response struct {
	Embedded ListOperationsForAccount200ResponseEmbedded `json:"_embedded"`
...
type _ListOperationsForAccount200Response ListOperationsForAccount200Response
...
func NewListOperationsForAccount200Response(embedded ListOperationsForAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListDashboards200ResponseLinks) *ListOperationsForAccount200Response {
	this := ListOperationsForAccount200Response{}
...
func (o *ListOperationsForAccount200Response) GetEmbedded() ListOperationsForAccount200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForAccount200ResponseEmbedded
		return ret
	}
...
func (o ListOperationsForAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForAccount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForAccount200Response := _ListOperationsForAccount200Response{}

	err = json.Unmarshal(data, &varListOperationsForAccount200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForAccount200Response(varListOperationsForAccount200Response)
...
type NullableListOperationsForAccount200Response struct {
	value *ListOperationsForAccount200Response
	isSet bool
}

func (v NullableListOperationsForAccount200Response) Get() *ListOperationsForAccount200Response {
	return v.value
}

func (v *NullableListOperationsForAccount200Response) Set(val *ListOperationsForAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForAccount200Response(val *ListOperationsForAccount200Response) *NullableListOperationsForAccount200Response {
	return &NullableListOperationsForAccount200Response{value: val, isSet: true}
}

func (v NullableListOperationsForAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

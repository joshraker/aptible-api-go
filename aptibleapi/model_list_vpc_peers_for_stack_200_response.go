...
// checks if the ListVpcPeersForStack200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVpcPeersForStack200Response{}

// ListVpcPeersForStack200Response struct for ListVpcPeersForStack200Response
type ListVpcPeersForStack200Response struct {
	Embedded ListVpcPeersForStack200ResponseEmbedded `json:"_embedded"`
...
type _ListVpcPeersForStack200Response ListVpcPeersForStack200Response
...
func NewListVpcPeersForStack200Response(embedded ListVpcPeersForStack200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListAccountsForStack200ResponseLinks) *ListVpcPeersForStack200Response {
	this := ListVpcPeersForStack200Response{}
...
func (o *ListVpcPeersForStack200Response) GetEmbedded() ListVpcPeersForStack200ResponseEmbedded {
	if o == nil {
		var ret ListVpcPeersForStack200ResponseEmbedded
		return ret
	}
...
func (o ListVpcPeersForStack200Response) MarshalJSON() ([]byte, error) {
...
func (o ListVpcPeersForStack200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListVpcPeersForStack200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListVpcPeersForStack200Response := _ListVpcPeersForStack200Response{}

	err = json.Unmarshal(data, &varListVpcPeersForStack200Response)

	if err != nil {
		return err
	}

	*o = ListVpcPeersForStack200Response(varListVpcPeersForStack200Response)
...
type NullableListVpcPeersForStack200Response struct {
	value *ListVpcPeersForStack200Response
	isSet bool
}

func (v NullableListVpcPeersForStack200Response) Get() *ListVpcPeersForStack200Response {
	return v.value
}

func (v *NullableListVpcPeersForStack200Response) Set(val *ListVpcPeersForStack200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListVpcPeersForStack200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListVpcPeersForStack200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVpcPeersForStack200Response(val *ListVpcPeersForStack200Response) *NullableListVpcPeersForStack200Response {
	return &NullableListVpcPeersForStack200Response{value: val, isSet: true}
}

func (v NullableListVpcPeersForStack200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVpcPeersForStack200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ListBackupRetentionPoliciesForAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListBackupRetentionPoliciesForAccount200Response{}

// ListBackupRetentionPoliciesForAccount200Response struct for ListBackupRetentionPoliciesForAccount200Response
type ListBackupRetentionPoliciesForAccount200Response struct {
	Embedded ListBackupRetentionPoliciesForAccount200ResponseEmbedded `json:"_embedded"`
...
type _ListBackupRetentionPoliciesForAccount200Response ListBackupRetentionPoliciesForAccount200Response
...
func (o *ListBackupRetentionPoliciesForAccount200Response) GetEmbedded() ListBackupRetentionPoliciesForAccount200ResponseEmbedded {
	if o == nil {
		var ret ListBackupRetentionPoliciesForAccount200ResponseEmbedded
		return ret
	}
...
func (o ListBackupRetentionPoliciesForAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o ListBackupRetentionPoliciesForAccount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListBackupRetentionPoliciesForAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListBackupRetentionPoliciesForAccount200Response := _ListBackupRetentionPoliciesForAccount200Response{}

	err = json.Unmarshal(data, &varListBackupRetentionPoliciesForAccount200Response)

	if err != nil {
		return err
	}

	*o = ListBackupRetentionPoliciesForAccount200Response(varListBackupRetentionPoliciesForAccount200Response)
...
type NullableListBackupRetentionPoliciesForAccount200Response struct {
	value *ListBackupRetentionPoliciesForAccount200Response
	isSet bool
}

func (v NullableListBackupRetentionPoliciesForAccount200Response) Get() *ListBackupRetentionPoliciesForAccount200Response {
	return v.value
}

func (v *NullableListBackupRetentionPoliciesForAccount200Response) Set(val *ListBackupRetentionPoliciesForAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListBackupRetentionPoliciesForAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListBackupRetentionPoliciesForAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListBackupRetentionPoliciesForAccount200Response(val *ListBackupRetentionPoliciesForAccount200Response) *NullableListBackupRetentionPoliciesForAccount200Response {
	return &NullableListBackupRetentionPoliciesForAccount200Response{value: val, isSet: true}
}

func (v NullableListBackupRetentionPoliciesForAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListBackupRetentionPoliciesForAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

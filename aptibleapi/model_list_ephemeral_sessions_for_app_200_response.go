...
// checks if the ListEphemeralSessionsForApp200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListEphemeralSessionsForApp200Response{}

// ListEphemeralSessionsForApp200Response struct for ListEphemeralSessionsForApp200Response
type ListEphemeralSessionsForApp200Response struct {
	Embedded ListEphemeralSessionsForApp200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListEphemeralSessionsForApp200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListEphemeralSessionsForApp200Response ListEphemeralSessionsForApp200Response
...
func NewListEphemeralSessionsForApp200Response(embedded ListEphemeralSessionsForApp200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListEphemeralSessionsForApp200ResponseLinks) *ListEphemeralSessionsForApp200Response {
	this := ListEphemeralSessionsForApp200Response{}
...
func (o *ListEphemeralSessionsForApp200Response) GetEmbedded() ListEphemeralSessionsForApp200ResponseEmbedded {
	if o == nil {
		var ret ListEphemeralSessionsForApp200ResponseEmbedded
		return ret
	}
...
func (o *ListEphemeralSessionsForApp200Response) GetLinks() ListEphemeralSessionsForApp200ResponseLinks {
	if o == nil {
		var ret ListEphemeralSessionsForApp200ResponseLinks
		return ret
	}
...
func (o ListEphemeralSessionsForApp200Response) MarshalJSON() ([]byte, error) {
...
func (o ListEphemeralSessionsForApp200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListEphemeralSessionsForApp200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListEphemeralSessionsForApp200Response := _ListEphemeralSessionsForApp200Response{}

	err = json.Unmarshal(data, &varListEphemeralSessionsForApp200Response)

	if err != nil {
		return err
	}

	*o = ListEphemeralSessionsForApp200Response(varListEphemeralSessionsForApp200Response)
...
type NullableListEphemeralSessionsForApp200Response struct {
	value *ListEphemeralSessionsForApp200Response
	isSet bool
}

func (v NullableListEphemeralSessionsForApp200Response) Get() *ListEphemeralSessionsForApp200Response {
	return v.value
}

func (v *NullableListEphemeralSessionsForApp200Response) Set(val *ListEphemeralSessionsForApp200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListEphemeralSessionsForApp200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListEphemeralSessionsForApp200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListEphemeralSessionsForApp200Response(val *ListEphemeralSessionsForApp200Response) *NullableListEphemeralSessionsForApp200Response {
	return &NullableListEphemeralSessionsForApp200Response{value: val, isSet: true}
}

func (v NullableListEphemeralSessionsForApp200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListEphemeralSessionsForApp200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

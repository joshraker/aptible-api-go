...
// checks if the ListStacks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListStacks200Response{}

// ListStacks200Response struct for ListStacks200Response
type ListStacks200Response struct {
	Embedded ListStacks200ResponseEmbedded `json:"_embedded"`
...
func (o *ListStacks200Response) GetEmbedded() ListStacks200ResponseEmbedded {
	if o == nil {
		var ret ListStacks200ResponseEmbedded
		return ret
	}
...
func (o ListStacks200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListStacks200Response) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varListStacks200Response)

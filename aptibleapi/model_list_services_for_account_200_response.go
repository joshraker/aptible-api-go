...
// checks if the ListServicesForAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListServicesForAccount200Response{}

// ListServicesForAccount200Response struct for ListServicesForAccount200Response
type ListServicesForAccount200Response struct {
	Embedded ListServicesForAccount200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListServicesForAccount200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListServicesForAccount200Response ListServicesForAccount200Response
...
func NewListServicesForAccount200Response(embedded ListServicesForAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListServicesForAccount200ResponseLinks) *ListServicesForAccount200Response {
	this := ListServicesForAccount200Response{}
...
func (o *ListServicesForAccount200Response) GetEmbedded() ListServicesForAccount200ResponseEmbedded {
	if o == nil {
		var ret ListServicesForAccount200ResponseEmbedded
		return ret
	}
...
func (o *ListServicesForAccount200Response) GetLinks() ListServicesForAccount200ResponseLinks {
	if o == nil {
		var ret ListServicesForAccount200ResponseLinks
		return ret
	}
...
func (o ListServicesForAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o ListServicesForAccount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListServicesForAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListServicesForAccount200Response := _ListServicesForAccount200Response{}

	err = json.Unmarshal(data, &varListServicesForAccount200Response)

	if err != nil {
		return err
	}

	*o = ListServicesForAccount200Response(varListServicesForAccount200Response)
...
type NullableListServicesForAccount200Response struct {
	value *ListServicesForAccount200Response
	isSet bool
}

func (v NullableListServicesForAccount200Response) Get() *ListServicesForAccount200Response {
	return v.value
}

func (v *NullableListServicesForAccount200Response) Set(val *ListServicesForAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListServicesForAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListServicesForAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListServicesForAccount200Response(val *ListServicesForAccount200Response) *NullableListServicesForAccount200Response {
	return &NullableListServicesForAccount200Response{value: val, isSet: true}
}

func (v NullableListServicesForAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListServicesForAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

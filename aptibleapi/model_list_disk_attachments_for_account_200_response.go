...
// checks if the ListDiskAttachmentsForAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDiskAttachmentsForAccount200Response{}

// ListDiskAttachmentsForAccount200Response struct for ListDiskAttachmentsForAccount200Response
type ListDiskAttachmentsForAccount200Response struct {
...
type _ListDiskAttachmentsForAccount200Response ListDiskAttachmentsForAccount200Response
...
func NewListDiskAttachmentsForAccount200Response(embedded ListDiskAttachmentsForAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListActivityReportsForAccount200ResponseLinks) *ListDiskAttachmentsForAccount200Response {
	this := ListDiskAttachmentsForAccount200Response{}
...
func (o ListDiskAttachmentsForAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o ListDiskAttachmentsForAccount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListDiskAttachmentsForAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDiskAttachmentsForAccount200Response := _ListDiskAttachmentsForAccount200Response{}

	err = json.Unmarshal(data, &varListDiskAttachmentsForAccount200Response)

	if err != nil {
		return err
	}

	*o = ListDiskAttachmentsForAccount200Response(varListDiskAttachmentsForAccount200Response)
...
type NullableListDiskAttachmentsForAccount200Response struct {
	value *ListDiskAttachmentsForAccount200Response
	isSet bool
}

func (v NullableListDiskAttachmentsForAccount200Response) Get() *ListDiskAttachmentsForAccount200Response {
	return v.value
}

func (v *NullableListDiskAttachmentsForAccount200Response) Set(val *ListDiskAttachmentsForAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDiskAttachmentsForAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDiskAttachmentsForAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDiskAttachmentsForAccount200Response(val *ListDiskAttachmentsForAccount200Response) *NullableListDiskAttachmentsForAccount200Response {
	return &NullableListDiskAttachmentsForAccount200Response{value: val, isSet: true}
}

func (v NullableListDiskAttachmentsForAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDiskAttachmentsForAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

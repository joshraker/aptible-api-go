...
// checks if the ListDatabasesForAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDatabasesForAccount200Response{}

// ListDatabasesForAccount200Response struct for ListDatabasesForAccount200Response
type ListDatabasesForAccount200Response struct {
	Embedded ListDatabasesForAccount200ResponseEmbedded `json:"_embedded"`
...
type _ListDatabasesForAccount200Response ListDatabasesForAccount200Response
...
func NewListDatabasesForAccount200Response(embedded ListDatabasesForAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListActivityReportsForAccount200ResponseLinks) *ListDatabasesForAccount200Response {
	this := ListDatabasesForAccount200Response{}
...
func (o *ListDatabasesForAccount200Response) GetEmbedded() ListDatabasesForAccount200ResponseEmbedded {
	if o == nil {
		var ret ListDatabasesForAccount200ResponseEmbedded
		return ret
	}
...
func (o ListDatabasesForAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o ListDatabasesForAccount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListDatabasesForAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDatabasesForAccount200Response := _ListDatabasesForAccount200Response{}

	err = json.Unmarshal(data, &varListDatabasesForAccount200Response)

	if err != nil {
		return err
	}

	*o = ListDatabasesForAccount200Response(varListDatabasesForAccount200Response)
...
type NullableListDatabasesForAccount200Response struct {
	value *ListDatabasesForAccount200Response
	isSet bool
}

func (v NullableListDatabasesForAccount200Response) Get() *ListDatabasesForAccount200Response {
	return v.value
}

func (v *NullableListDatabasesForAccount200Response) Set(val *ListDatabasesForAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDatabasesForAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDatabasesForAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDatabasesForAccount200Response(val *ListDatabasesForAccount200Response) *NullableListDatabasesForAccount200Response {
	return &NullableListDatabasesForAccount200Response{value: val, isSet: true}
}

func (v NullableListDatabasesForAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDatabasesForAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ListAccountsForStack200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAccountsForStack200Response{}

// ListAccountsForStack200Response struct for ListAccountsForStack200Response
type ListAccountsForStack200Response struct {
	Embedded ListAccountsForStack200ResponseEmbedded `json:"_embedded"`
...
type _ListAccountsForStack200Response ListAccountsForStack200Response
...
func NewListAccountsForStack200Response(embedded ListAccountsForStack200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListAccountsForStack200ResponseLinks) *ListAccountsForStack200Response {
	this := ListAccountsForStack200Response{}
...
func (o *ListAccountsForStack200Response) GetEmbedded() ListAccountsForStack200ResponseEmbedded {
	if o == nil {
		var ret ListAccountsForStack200ResponseEmbedded
		return ret
	}
...
func (o ListAccountsForStack200Response) MarshalJSON() ([]byte, error) {
...
func (o ListAccountsForStack200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListAccountsForStack200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListAccountsForStack200Response := _ListAccountsForStack200Response{}

	err = json.Unmarshal(data, &varListAccountsForStack200Response)

	if err != nil {
		return err
	}

	*o = ListAccountsForStack200Response(varListAccountsForStack200Response)
...
type NullableListAccountsForStack200Response struct {
	value *ListAccountsForStack200Response
	isSet bool
}

func (v NullableListAccountsForStack200Response) Get() *ListAccountsForStack200Response {
	return v.value
}

func (v *NullableListAccountsForStack200Response) Set(val *ListAccountsForStack200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAccountsForStack200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAccountsForStack200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAccountsForStack200Response(val *ListAccountsForStack200Response) *NullableListAccountsForStack200Response {
	return &NullableListAccountsForStack200Response{value: val, isSet: true}
}

func (v NullableListAccountsForStack200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAccountsForStack200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

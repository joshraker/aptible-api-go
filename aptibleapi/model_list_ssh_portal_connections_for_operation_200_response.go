...
// checks if the ListSshPortalConnectionsForOperation200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSshPortalConnectionsForOperation200Response{}

// ListSshPortalConnectionsForOperation200Response struct for ListSshPortalConnectionsForOperation200Response
type ListSshPortalConnectionsForOperation200Response struct {
	Embedded ListSshPortalConnectionsForOperation200ResponseEmbedded `json:"_embedded"`
...
type _ListSshPortalConnectionsForOperation200Response ListSshPortalConnectionsForOperation200Response
...
func NewListSshPortalConnectionsForOperation200Response(embedded ListSshPortalConnectionsForOperation200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListDashboards200ResponseLinks) *ListSshPortalConnectionsForOperation200Response {
	this := ListSshPortalConnectionsForOperation200Response{}
...
func (o *ListSshPortalConnectionsForOperation200Response) GetEmbedded() ListSshPortalConnectionsForOperation200ResponseEmbedded {
	if o == nil {
		var ret ListSshPortalConnectionsForOperation200ResponseEmbedded
		return ret
	}
...
func (o ListSshPortalConnectionsForOperation200Response) MarshalJSON() ([]byte, error) {
...
func (o ListSshPortalConnectionsForOperation200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListSshPortalConnectionsForOperation200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListSshPortalConnectionsForOperation200Response := _ListSshPortalConnectionsForOperation200Response{}

	err = json.Unmarshal(data, &varListSshPortalConnectionsForOperation200Response)

	if err != nil {
		return err
	}

	*o = ListSshPortalConnectionsForOperation200Response(varListSshPortalConnectionsForOperation200Response)
...
type NullableListSshPortalConnectionsForOperation200Response struct {
	value *ListSshPortalConnectionsForOperation200Response
	isSet bool
}

func (v NullableListSshPortalConnectionsForOperation200Response) Get() *ListSshPortalConnectionsForOperation200Response {
	return v.value
}

func (v *NullableListSshPortalConnectionsForOperation200Response) Set(val *ListSshPortalConnectionsForOperation200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSshPortalConnectionsForOperation200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSshPortalConnectionsForOperation200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSshPortalConnectionsForOperation200Response(val *ListSshPortalConnectionsForOperation200Response) *NullableListSshPortalConnectionsForOperation200Response {
	return &NullableListSshPortalConnectionsForOperation200Response{value: val, isSet: true}
}

func (v NullableListSshPortalConnectionsForOperation200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSshPortalConnectionsForOperation200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
